...
<head>
    ...
    <title>Admin Dashboard - Prescriptions</title>
                            ...
                            <?php while ($row = $result->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="admin_dashboard_prescriptions.php?prescription_id=<?php echo $row['prescription_id']; ?>&action=delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
